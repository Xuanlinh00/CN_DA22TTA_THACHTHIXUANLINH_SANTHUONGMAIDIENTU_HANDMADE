    ...
    <footer className="bg-primary-900 text-primary-100 mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/products" className="hover:text-accent-400 transition-colors">
                  Sản phẩm
                </Link>
              </li>
              <li>
                <Link to="/shops" className="hover:text-accent-400 transition-colors">
                  Cửa hàng
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/shipping" className="hover:text-accent-400 transition-colors">
                  Chính sách vận chuyển
                </Link>
              </li>
              <li>
                <Link to="/returns" className="hover:text-accent-400 transition-colors">
                  Đổi trả hàng
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-primary-800 mt-8 pt-8 text-center text-sm text-primary-300">
          <p>&copy; {new Date().getFullYear()} Craftify Handmade. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
